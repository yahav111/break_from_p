...
const _grades = [
  ...
  _Grade(14, 'שבועיים'),
  _Grade(21, '3 שבועות'),
  _Grade(30, 'חודש', milestoneTitle: 'חירות אמיתית', characterStage: CharacterStage.phoenix),
  _Grade(45, '45 ימים'),
  _Grade(60, 'חודשיים', milestoneTitle: 'שולט בשליטה', characterStage: CharacterStage.nova),
  _Grade(90, '3 חודשים', milestoneTitle: 'גיבור האור', characterStage: CharacterStage.cosmos),
  _Grade(120, '4 חודשים'),
  _Grade(150, '5 חודשים'),
  _Grade(180, '6 חודשים'),
  _Grade(270, '9 חודשים'),
