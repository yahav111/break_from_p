# Quittr — Product Vision Deep Dive

## The Recovery Journey

Quittr frames quitting porn as a **space journey** — the user is launching into a new life, leaving the old behind. This metaphor runs through the entire UX:

- **Star field backgrounds** — The user is traveling through space
- **"Brain Rewire" progress** — Based on the neuroscience concept that the brain takes ~90 days to rewire dopamine pathways
- **Streak as mission days** — "Day 91" feels like a space mission log
- **Dark theme** — Space aesthetic, also practical for discreet nighttime use
...
The onboarding quiz serves multiple purposes:
1. **Personalization** — Tailor the experience based on severity/patterns
2. **Self-awareness** — Help users recognize their patterns
3. **Investment** — Users who invest time in setup are more likely to stay
4. **Segmentation** — Inform which premium features to highlight
